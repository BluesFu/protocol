...
func (c *greeterClient) SayHello(ctx context.Context, in *SayHelloReq, opts ...grpc.CallOption) (*SayHelloRsp, error) {
	out := new(SayHelloRsp)
...
func (UnimplementedGreeterServer) SayHello(context.Context, *SayHelloReq) (*SayHelloRsp, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "demo/helloworld.proto",
}
